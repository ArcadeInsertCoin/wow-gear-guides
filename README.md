...
## 📑 Table of Contents 
- [🏹 Marksmanship Hunter (Ahhotep)](#-marksmanship-hunter--gear-guide-classic-phase-5)  
  - 🎒 Current Gear  
  - 🔥 Raid Setup  
  - ⚔️ PvP Setup  
  - 🌿 Solo / Farming  
- [🔮 Shadow Priest (Hatschepsut)](#-shadow-priest--gear-guide-classic-phase-5)  
  - 🎒 Current Gear  
...
- Head: ❌ (Best: **Dragonstalker’s Helm** – Onyxia)  
- Neck: ✅ **Eye of Hakkar** (ZG)  
- Shoulders: ✅ **Giantstalker Epaulets** (MC)  
- Back: ✅ **Earthweaver Cloak** (ZG)  
- Chest: ✅ **Giantstalker Breastplate** (MC)  
- Wrists: ❌ (Best: **Ossirian’s Binding** – AQ20)  
- Hands: ✅ **Giantstalker Gloves** (MC)  
- Waist: ✅ **Zandalar Predator’s Belt** (ZG)  
- Legs: ❌ (Best: **Dragonstalker’s Legguards** – Ragnaros)  
...
- Ranged: ❌ (Best: **Striker’s Mark** – AQ40)  

---

## 🔥 Raid Setup (DPS)
Optimized for Molten Core, BWL & AQ40.

| Slot | Current | Upgrade Path | Status |
|------|---------|--------------|--------|
| Head | — | **Dragonstalker’s Helm (Onyxia)** | ❌ |
| Neck | Eye of Hakkar | **Prestor’s Talisman (BWL)** | ❌ |
| Shoulders | Giantstalker Epaulets | **Dragonstalker’s Spaulders (BWL)** | ✅ |
...
| Hands | Giantstalker Gloves | **Gauntlets of Annihilation (AQ40)** | ✅ |
| Waist | Zandalar Predator’s Belt | **Belt of Never-ending Agony (AQ40)** | ✅ |
| Legs | — | **Dragonstalker’s Legguards (MC)** | ❌ |
| Feet | Blooddrenched Footpads | **Boots of the Shadow Flame (BWL)** | ✅ |
| Rings | Royal Seal | **Band of Accuria (MC)** | ✅ |
| Trinkets | Devilsaur Eye + Blackhand’s Breadth | **Drake Fang Talisman (BWL)** | ✅ |
| Weapons | Barbarous Blade | **Ashkandi (BWL)** | ✅ |
| Ranged | — | **Striker’s Mark (AQ40)** | ❌ |

---

## ⚔️ PvP Setup
- High stamina + burst trinkets.  
- Insignia of the Alliance is mandatory.  

| Slot | Item | Status |
|------|------|--------|
| Head | Dragonstalker’s Helm (Ony) | ❌ |
| Neck | Eye of Hakkar | ✅ |
...
| Waist | Zandalar Predator’s Belt | ✅ |
| Feet | Blooddrenched Footpads | ✅ |
| Rings | Royal Seal + Devilsaur Eye | ✅ |
| Trinkets | Devilsaur Eye + Blackhand’s Breadth | ✅ |
| Weapon | Huntsman’s Harpoon | ✅ |
...
- Weapon: ✅ **Scepter of the Unholy**, ✅ **Simone’s Hammer**  
...
| Slot | Current | Upgrade Path | Status |
|------|---------|--------------|--------|
| Head | Spellweaver’s Turban | T2.5 AQ40 Head | ✅ |
| Neck | Charm of the Shifting Sands | — | ✅ |
...
| Weapon | Scepter of the Unholy + Tome | **Staff of the Ruins (AQ20)** | ✅ |
| Wand | Touch of Chaos | — | ✅ |

---

## ✝️ Raid Setup (Healing Backup)
(Uses Prophecy & Wisdom Set)  

✅ Already strong. Best upgrade path: **Zandalarian Hero Charm (ZG)** + AQ healing gear.

---

## ⚔️ PvP Setup
- Burst crit + stamina balance.  
- **Insignia of the Alliance** mandatory.  

| Slot | Item | Status |
|------|------|--------|
| Head | Spellweaver’s Turban | ✅ |
| Neck | Charm of the Shifting Sands | ✅ |
| Shoulders | Felcloth / ZG | ✅ |
...
| Weapon | Scepter of the Unholy + Tome | ✅ |
| Wand | Touch of Chaos | ✅ |
...
# 📌 Final Notes
- ✅ = Owned ❌ = Still Missing  
- **Hunter priority farm:** Dragonstalker Helm (Onyxia), Prestor’s Talisman (BWL), Band of Accuria (MC).  
- **Priest priority farm:** Mantle of the Blackwing Cabal (BWL), Cloak of Consumption (ZG), Band of Forced Concentration (BWL).  
- Both dashboards are combined in this one `README.md` → no need for separate files.  
